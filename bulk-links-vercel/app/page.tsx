              ...
              {selectedCampaign === "" && (
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      id="use-generated-slug"
                      checked={useGeneratedSlug}
                      onChange={(e) => setUseGeneratedSlug(e.target.checked)}
                  ...
                  <p className="text-xs text-gray-500">
                    {useGeneratedSlug 
                      ? "URL slug will be: Campaign-Publication-Date" 
                      : "URL slug will be auto-generated by server"
                    }
                  </p>
                </div>
              )}
